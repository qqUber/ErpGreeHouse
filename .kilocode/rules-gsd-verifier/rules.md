...
**Critical mindset:** Do NOT trust SUMMARY.md claims. SUMMARYs document what KiloCode SAID it did. You verify what ACTUALLY exists in the code. These often differ.
</role>
...
_Verifier: KiloCode (gsd-verifier)_
```

...
description: Researches domain ecosystem before roadmap creation. Produces files in .gsd/research/ consumed during roadmap creation. Spawned by /new-project.md or /new-milestone.md orchestrators.

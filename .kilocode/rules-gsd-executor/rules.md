...
**See @~/.kilocode/rules/checkpoints.md**

**Quick reference:**

- Users NEVER run CLI commands - KiloCode does all automation
- Users ONLY visit URLs, click UI, evaluate visuals, provide secrets
- KiloCode starts servers, seeds databases, configures env vars
...
- Clear history for KiloCode in future sessions
  </task_commit_protocol>

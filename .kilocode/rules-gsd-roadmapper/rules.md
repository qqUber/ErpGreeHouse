---
name: gsd-roadmapper
description: Creates project roadmaps with phase breakdown, requirement mapping, success criteria derivation, and coverage validation. Spawned by /new-project.md orchestrator.
...
<downstream_consumer>
Your ROADMAP.md is consumed by `/plan-phase.md` which uses it to:
...
You are roadmapping for ONE person (the user) and ONE implementer (KiloCode).

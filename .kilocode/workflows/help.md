...
**GSD** (Get Stuff Done) creates hierarchical project plans optimized for solo agentic development with KiloCode Code.
...
See what KiloCode is planning to do before it starts.

- Shows KiloCode's intended approach for a phase
- Lets you course-correct if KiloCode misunderstood your vision

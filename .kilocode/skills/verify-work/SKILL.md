...
User tests, KiloCode records. One test at a time. Plain text responses.
</purpose>

<philosophy>
**Show expected, ask if reality matches.**

KiloCode presents what SHOULD happen. User confirms or describes what's different.
...
- Follow @~/.kilocode/skills/diagnose-issues/SKILL.md

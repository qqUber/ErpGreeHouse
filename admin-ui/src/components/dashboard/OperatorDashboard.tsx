  ...
  return (
    <div className="space-y-6 stagger-children" data-testid="operator_dashboard_en">
      ...
      <div
        ...
        data-testid="operator_widget_quick_actions_en"
      >
        <button
      ...
      {data?.operational && (
        <div
          ...
          data-testid="operator_widget_shift_stats_en"
        >
          <div className="card">
          ...
          <div className="card">
            ...
            <div className="text-3xl font-bold">
              {formatCurrency(data.operational.total_revenue)}
            </div>
          </div>
      ...
      {(!data?.operational || data.operational.total_transactions === 0) && (
        <div
          className="card cardFull text-center py-12"
          data-testid="operator_widget_empty_state_en"
        >

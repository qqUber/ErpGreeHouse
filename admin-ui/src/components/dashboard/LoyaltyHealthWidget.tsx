        ...
        <div className="crm-list">
          <div className="crm-customer-row">
            <div className="crm-customer-main">
              <span className="crm-customer-name">{earnedLabel}</span>
            </div>
            <div className="crm-customer-badges">
              <span className="crm-badge crm-badge-value">{pointsEarned.toLocaleString()}</span>
              <span className="crm-badge crm-badge-muted">Issued points</span>
            </div>
          </div>
          <div className="crm-customer-row">
            <div className="crm-customer-main">
              <span className="crm-customer-name">{redeemedLabel}</span>
            </div>
            <div className="crm-customer-badges">
              <span className="crm-badge crm-badge-good">{pointsRedeemed.toLocaleString()}</span>
              <span className="crm-badge crm-badge-muted">Used points</span>
            </div>
          </div>
          <div className="crm-customer-row">
            <div className="crm-customer-main">
              <span className="crm-customer-name">{redemptionLabel}</span>
            </div>
            <div className="crm-customer-badges">
              <span className="crm-badge crm-badge-warn">{redemptionRate.toFixed(1)}%</span>
              <span className="crm-badge crm-badge-muted">Redemption performance</span>
            </div>
          </div>
          <div className="crm-customer-row">
            <div className="crm-customer-main">
              <span className="crm-customer-name">
                {t('widgets.loyaltyHealth.avgOrder', 'Avg order value')}
              </span>
            </div>
            <div className="crm-customer-badges">
              <span className="crm-badge crm-badge-value">{avgOrderValue.toLocaleString()}</span>
              <span className="crm-badge crm-badge-muted">Average ticket value</span>
            </div>
          </div>
        </div>
      </section>

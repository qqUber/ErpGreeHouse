...
describe('Pagination Component', () => {
  it('should not render if total items <= limit', () => {
    ...
    const { container } = renderWithI18n(
      <Pagination page={1} totalPages={1} total={10} limit={10} onPageChange={onPageChange} />
    );
  ...
  it('should render ellipsis when there are many pages', () => {
    const onPageChange = vi.fn();
    renderWithI18n(
      <Pagination page={5} totalPages={10} total={100} limit={10} onPageChange={onPageChange} />
    );
  ...
  it('should disable next button on last page', () => {
    const onPageChange = vi.fn();
    renderWithI18n(
      <Pagination page={5} totalPages={5} total={50} limit={10} onPageChange={onPageChange} />
    );

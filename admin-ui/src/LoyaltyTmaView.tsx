      ...
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden max-w-sm mx-auto p-6 flex flex-col items-center">
        ...
        <div className="w-full bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-6 text-white mb-6 shadow-xl relative overflow-hidden">
          ...
          <div className="flex justify-between items-start mb-4">
            <div>
              <p className="text-xs font-bold uppercase tracking-widest opacity-70 mb-1">Ваш статус</p>
            ...
            <div className="mt-4">
              ...
              <div className="w-full bg-white/20 h-2 rounded-full overflow-hidden">
                <div 
                  ...
                  style={{ width: `${Math.min(100, (data.spent_amount / data.next_tier_spent) * 100)}%` }}
                ></div>
              </div>
          ...
          <div className="mt-6 pt-4 border-t border-white/10 flex justify-between items-center">
            ...
            <span className="bg-white/20 px-2 py-1 rounded text-[10px] font-bold uppercase">Active card</span>
          </div>
        </div>

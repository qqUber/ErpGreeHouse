...
const accessibilityScore =
  Math.round(
    ((ariaCount + roleCount + altTextCount) /
      (ariaCount + roleCount + altTextCount + missingAltCount + 1)) *
      100
  ) || 0;
...
const semanticScore =
  Math.round(
    ((headerCount + navCount + mainCount + sectionCount + articleCount + asideCount + footerCount) /
      (tsxFiles.length * 3)) *
      100
  ) || 0;

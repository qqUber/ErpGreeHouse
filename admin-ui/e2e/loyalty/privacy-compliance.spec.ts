...
test.describe
  .skip('Green House Loyalty Demo - Privacy Compliance', () => {
    ...
    test('data retention and deletion policies', async ({ page }) => {
      ...
      const userDataResponse = await page.request.post(
    ...
    test('data export functionality', async ({ page }) => {
      ...
      const comprehensiveDataResponse = await page.request.post(
        '/api/v1/test/telegram/comprehensive-data',
        {
          data: {
    ...
    test('consent withdrawal and processing updates', async ({ page }) => {
      ...
      const updatedProcessingResponse = await page.request.post(
        '/api/v1/test/telegram/process-data',
        {
          data: {
            user_id: 'test_consent_withdrawal',
            operations: ['marketing_campaign', 'analytics_tracking', 'loyalty_bonus', 'profiling'],
    ...
    test('privacy policy updates and user notification', async ({ page }) => {
      ...
      const existingUserResponse = await page.request.post(
        '/api/v1/test/telegram/complete-registration',
        {
          data: {
      ...
      const rejectionResponse = await page.request.post(
        '/api/v1/test/telegram/policy-update-response',
        {
          data: {

...
test.describe
  .skip('Green House Loyalty Demo - Negative Tests', () => {
    ...
    test('expired bonus scenarios', async ({ page }) => {
      ...
      const expiredBonusResponse = await page.request.post(
        '/api/v1/test/telegram/expired-bonus-setup',
        {
          data: {
    ...
    test('disabled user handling', async ({ page }) => {
      ...
      const disabledUserResponse = await page.request.post(
        '/api/v1/test/telegram/disabled-user-setup',
        {
          data: {
    ...
    test('duplicate registration prevention', async ({ page }) => {
      ...
      const firstRegistration = await page.request.post(
      ...
      const duplicatePhoneResponse = await page.request.post(
        '/api/v1/test/telegram/complete-registration',
        {
          data: {
      ...
      const duplicateEmailResponse = await page.request.post(
        '/api/v1/test/telegram/complete-registration',
        {
          data: {
    ...
    test('network failure recovery', async ({ page }) => {
      ...
      const webhookFailureResponse = await page.request.post(
        '/api/v1/test/telegram/webhook-failure',
        {
          data: {
      ...
      const transactionFailureResponse = await page.request.post(
        '/api/v1/test/telegram/transaction-failure',
        {
          data: {
            simulate_failure: true,

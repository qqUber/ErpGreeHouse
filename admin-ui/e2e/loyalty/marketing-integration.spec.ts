...
test.describe
  .skip('Green House Loyalty Demo - Marketing Integration', () => {
    ...
    test('channel link functionality', async ({ page }) => {
      ...
      const userSetupResponse = await page.request.post(
        '/api/v1/test/telegram/complete-registration',
        {
          data: {
      ...
      const channelLinkResponse = await page.request.post(
        '/api/v1/test/telegram/marketing/channel-link',
        {
          data: {
            user_id: 'test_marketing_user',
      ...
      for (const channelType of channelTypes) {
        const multiChannelResponse = await page.request.post(
          '/api/v1/test/telegram/marketing/channel-link',
          {
            data: {
              user_id: 'test_marketing_user',
    ...
    test('marketing menu items and accessibility', async ({ page }) => {
      ...
      const menuUserResponse = await page.request.post(
        '/api/v1/test/telegram/complete-registration',
        {
          data: {
      ...
      const menuDisplayResponse = await page.request.post(
        '/api/v1/test/telegram/marketing/show-menu',
        {
          data: {
            user_id: 'test_menu_user',
            menu_type: 'main',
      ...
      const vacanciesResponse = await page.request.post(
        '/api/v1/test/telegram/marketing/vacancies',
        {
          data: {
            user_id: 'test_menu_user',
            location: 'all',
      ...
      const promotionsResponse = await page.request.post(
        '/api/v1/test/telegram/marketing/promotions',
        {
          data: {
            user_id: 'test_menu_user',
      ...
      for (const userType of userTypes) {
        const userTypeResponse = await page.request.post(
          '/api/v1/test/telegram/marketing/show-menu',
          {
            data: {
    ...
    test('CRM campaign triggers and automation', async ({ page }) => {
      ...
      const campaignUserResponse = await page.request.post(
        '/api/v1/test/telegram/complete-registration',
        {
          data: {
      ...
      await expect(page.getByTestId('admin_nav_marketing')).toHaveAttribute(
        'aria-selected',
        'true'
      );

      // Test welcome campaign trigger
      const welcomeCampaignResponse = await page.request.post(
        '/api/v1/test/crm/trigger-welcome-campaign',
        {
          data: {
            user_id: 'test_campaign_user',
      ...
      const milestoneCampaignResponse = await page.request.post(
        '/api/v1/test/crm/trigger-milestone-campaign',
        {
          data: {
            user_id: 'test_campaign_user',
      ...
      const reengageCampaignResponse = await page.request.post(
        '/api/v1/test/crm/trigger-reengage-campaign',
        {
          data: {
      ...
      const birthdayCampaignResponse = await page.request.post(
        '/api/v1/test/crm/trigger-birthday-campaign',
        {
          data: {
            user_id: 'test_campaign_user',
            birthday: '1990-01-01',
    ...
    test('customer segmentation and personalization', async ({ page }) => {
      ...
      for (const profile of userProfiles) {
        const userCreationResponse = await page.request.post(
          '/api/v1/test/telegram/create-profiled-user',
          {
            data: profile,
          }
        );
      ...
      for (const profile of userProfiles) {
        const personalizationResponse = await page.request.post(
          '/api/v1/test/marketing/personalized-content',
          {
            data: {
      ...
      const recommendationResponse = await page.request.post(
        '/api/v1/test/marketing/recommendations',
        {
          data: {
            user_id: 'regular_customer',
    ...
    test('marketing analytics and reporting', async ({ page }) => {
      ...
      const dataGenerationResponse = await page.request.post(
        '/api/v1/test/marketing/generate-data',
        {
          data: {
            duration_days: 30,
      ...
      const dashboardResponse = await page.request.get(
        '/api/v1/test/marketing/dashboard-analytics'
      );
      ...
      const campaignMetricsResponse = await page.request.get(
        '/api/v1/test/marketing/campaign-metrics'
      );
      ...
      const predictiveResponse = await page.request.post(
        '/api/v1/test/marketing/predictive-analytics',
        {
          data: {
    ...
    test('multi-channel marketing integration', async ({ page }) => {
      ...
      const multiChannelUserResponse = await page.request.post(
        '/api/v1/test/telegram/complete-registration',
        {
          data: {
      ...
      const multiChannelResponse = await page.request.post(
        '/api/v1/test/marketing/multi-channel-campaign',
        {
          data: {
      ...
      const preferenceResponse = await page.request.post(
        '/api/v1/test/marketing/respect-preferences',
        {
          data: {
            user_id: 'test_multichannel_user',
      ...
      const trackingResponse = await page.request.post(
        '/api/v1/test/marketing/cross-channel-tracking',
        {
          data: {
            user_id: 'test_multichannel_user',
            interaction_chain: [
      ...
      const optimizationResponse = await page.request.post(
        '/api/v1/test/marketing/channel-optimization',
        {
          data: {
            user_id: 'test_multichannel_user',
      ...
      const unifiedViewResponse = await page.request.get(
        '/api/v1/test/marketing/unified-customer-view',
        {
    ...
    test('marketing automation workflows', async ({ page }) => {
      ...
      const automationUserResponse = await page.request.post(
        '/api/v1/test/telegram/complete-registration',
        {
          data: {
      ...
      const welcomeSeriesResponse = await page.request.post(
        '/api/v1/test/marketing/automation/welcome-series',
        {
          data: {
            user_id: 'test_automation_user',
      ...
      const cartRecoveryResponse = await page.request.post(
        '/api/v1/test/marketing/automation/cart-recovery',
        {
          data: {
            user_id: 'test_automation_user',
      ...
      const reengageAutomationResponse = await page.request.post(
        '/api/v1/test/marketing/automation/re-engagement',
        {
          data: {
            user_id: 'test_inactive_user',
            inactive_days: 30,
      ...
      const birthdayAutomationResponse = await page.request.post(
        '/api/v1/test/marketing/automation/birthday',
        {
          data: {
            user_id: 'test_automation_user',
            birthday: '1990-01-01',
      ...
      const vipAutomationResponse = await page.request.post(
        '/api/v1/test/marketing/automation/vip',
        {
          data: {
      ...
      const performanceResponse = await page.request.get(
        '/api/v1/test/marketing/automation/performance'
      );

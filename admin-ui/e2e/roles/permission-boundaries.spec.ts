 ...
 * - Tests use token from localStorage and pass it via 'x-admin-secret' header
 * - This is the OLD pattern, maintained for backward compatibility
 * - NEW tests should use JWT cookies (httpOnly) via fetchWithAuth
 */
...
test.describe('Permission Boundaries', () => {
   ...
   *
   * ⚠️ LEGACY AUTH PATTERN: These tests use x-admin-secret header

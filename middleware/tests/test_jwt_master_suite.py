...
class TestJWTIntegration:
    ...
    def test_full_auth_cycle(self, mock_get_db, client, mock_admin):
        ...
        with patch('app.admin_auth_api._get_admin_by_id', return_value={"id": 1, "username": mock_admin["username"], "role": mock_admin["role"]}):
        ...
        me_resp_after = client.get("/api/v1/auth/me", cookies=new_cookies)

...
class TestRoleBasedEndpointAccess:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("/api/v1/dashboard", "GET", "owner", 200),
            ...
            ("/api/v1/customers", "GET", "operator", 200),
            ("/api/v1/customers", "GET", "observer", 200),
            ("/api/v1/customers", "POST", "owner", 200),
            ...
            ("/api/v1/products", "GET", "operator", 200),
            ("/api/v1/products", "GET", "observer", 200),
            ("/api/v1/products", "POST", "owner", 200),
            ...
            ("/api/v1/orders", "GET", "operator", 200),
            ("/api/v1/orders", "GET", "observer", 403),
            ("/api/v1/orders", "POST", "owner", 200),
            ...
            ("/api/v1/marketing/campaigns", "GET", "operator", 403),
            ("/api/v1/marketing/campaigns", "GET", "observer", 403),
            ("/api/v1/marketing/campaigns", "POST", "owner", 200),
            ...
            ("/api/v1/integrations", "GET", "operator", 403),
            ("/api/v1/integrations", "GET", "observer", 403),
            ("/api/v1/integrations", "POST", "owner", 200),
            ...
            ("/api/v1/settings", "GET", "operator", 403),
            ("/api/v1/settings", "GET", "observer", 403),
            ("/api/v1/settings/roles", "GET", "owner", 200),
            ...
            ("/api/v1/reports", "GET", "operator", 403),
            ("/api/v1/reports", "GET", "observer", 200),
        ],
    )
    def test_endpoint_access_by_role(
        ...
        Args:
            ...
            role: User role (owner, marketer, operator, observer)
...
class TestRoleBasedEndpointAccessFromMatrix:
    ...
    def test_from_matrix(self, client: TestClient, test_case: dict[str, Any]) -> None:
        ...
        # Note: This test requires dynamic parametrize which is handled separately
        pass

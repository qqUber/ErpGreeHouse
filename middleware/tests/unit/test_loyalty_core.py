...
class TestClampRedeemPoints:
    ...
    def test_clamp_zero_total(self):
        ...
        result = clamp_redeem_points(
            total_amount=0, spent_amount=0, requested_points=100, 
            available_points=100, rules=rules
        )
    ...
    def test_clamp_zero_requested(self):
        ...
        result = clamp_redeem_points(
            total_amount=1000, spent_amount=0, requested_points=0, 
            available_points=100, rules=rules
        )
    ...
    def test_clamp_zero_available(self):
        ...
        result = clamp_redeem_points(
            total_amount=1000, spent_amount=0, requested_points=100, 
            available_points=0, rules=rules
        )
    ...
    def test_clamp_base_tier(self):
        ...
        result = clamp_redeem_points(
            total_amount=1000, spent_amount=0, requested_points=1000, 
            available_points=1000, rules=rules
        )
    ...
    def test_clamp_silver_tier(self):
        ...
        result = clamp_redeem_points(
            total_amount=1000, spent_amount=15000, requested_points=1000, 
            available_points=1000, rules=rules
        )
    ...
    def test_clamp_gold_tier(self):
        ...
        result = clamp_redeem_points(
            total_amount=1000, spent_amount=60000, requested_points=2000, 
            available_points=2000, rules=rules
        )
    ...
    def test_clamp_below_available(self):
        ...
        result = clamp_redeem_points(
            total_amount=1000, spent_amount=0, requested_points=100, 
            available_points=500, rules=rules
        )

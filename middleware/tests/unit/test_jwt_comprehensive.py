...
class TestJWTTokenCreation:
    ...
    def test_create_access_token_basic(self):
        ...
        admin = {"user_id": 1, "username": "test_user", "role": "admin"}
    ...
    def test_create_access_token_with_permissions(self):
        ...
        admin = {"user_id": 1, "username": "test_user", "role": "owner"}
    ...
    def test_create_refresh_token_basic(self):
        ...
        admin = {"user_id": 1, "username": "test_user"}
...
class TestGetAdminFromJWT:
    ...
    def test_get_admin_from_jwt_none_values(self):
        ...
        payload = {"sub": None, "username": None, "role": None, "permissions": None}

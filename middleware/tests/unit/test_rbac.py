...
class TestPasswordRecoveryRateLimiting:
    ...
    def test_rate_limiting_works(self, clean_database):
        """
        ...
        with patch('app.admin_auth_api.get_settings') as mock_settings:
            mock_settings.return_value = MagicMock(
                recovery_rate_limit_attempts=5,
    ...
    def test_rate_limiting_per_ip(self, clean_database):
        """
        ...
        with patch('app.admin_auth_api.get_settings') as mock_settings:
            mock_settings.return_value = MagicMock(
                recovery_rate_limit_attempts=2,
                recovery_rate_limit_window_seconds=60
            )

...
from app.db import get_db_path, get_db, DB


# Realistic Russian names (ФИО)
RUSSIAN_FIRST_NAMES_MALE = [
    "Иван", "Александр", "Дмитрий", "Михаил", "Сергей", "Андрей", "Владимир",
    "Николай", "Евгений", "Максим", "Юрий", "Олег", "Павел", "Артем", "Константин",
    "Илья", "Кирилл", "Макар", "Григорий", "Борис", "Виктор", "Станислав"
]

RUSSIAN_FIRST_NAMES_FEMALE = [
    "Анна", "Екатерина", "Мария", "Ольга", "Наталья", "Ирина", "Елена",
    "Татьяна", "Светлана", "Алена", "Дарья", "Ксения", "Алина", "Виктория",
    "Полина", "Елизавета", "Юлия", "Милана", "Алиса", "Оксана", "Людмила"
]

RUSSIAN_PATRONYMICS_MALE = [
    "Петрович", "Александрович", "Дмитриевич", "Михайлович", "Сергеевич",
    "Андреевич", "Владимирович", "Николаевич", "Евгеньевич", "Максимович",
    "Юрьевич", "Олегович", "Павлович", "Артемович", "Константинович"
]

RUSSIAN_PATRONYMICS_FEMALE = [
    "Петровна", "Александровна", "Дмитриевна", "Михайловна", "Сергеевна",
    "Андреевна", "Владимировна", "Николаевна", "Евгеньевна", "Максимовна",
    "Юрьевна", "Олеговна", "Павловна", "Артемовна", "Константиновна"
]

RUSSIAN_LAST_NAMES_MALE = [
    "Сидоров", "Козлов", "Волков", "Петров", "Иванов", "Смирнов", "Кузнецов",
    "Васильев", "Попов", "Соколов", "Лебедев", "Новиков", "Морозов", "Фёдоров",
    "Андреев", "Яковлев", "Григорьев", "Романов", "Осипов", "Никитин", "Захаров"
]

RUSSIAN_LAST_NAMES_FEMALE = [
    "Сидорова", "Козлова", "Волкова", "Петрова", "Иванова", "Смирнова", "Кузнецова",
    "Васильева", "Попова", "Соколова", "Лебедева", "Новикова", "Морозова", "Фёдорова",
    "Андреева", "Яковлева", "Григорьева", "Романова", "Осипова", "Никитина", "Захарова"
]

# Realistic Serbian names
SERBIAN_FIRST_NAMES_MALE = [
    "Милош", "Петар", "Ненад", "Драган", "Зоран", "Горан", "Слободан",
    "Душан", "Бранислав", "Владимир", "Саша", "Иван", "Марко", "Никола",
    "Стефан", "Александар", "Михајло", "Филип", "Лазар", "Андреа", "Борис"
]

SERBIAN_FIRST_NAMES_FEMALE = [
    "Драгана", "Милена", "Снежана", "Гордана", "Зорица", "Светлана", "Биљана",
    "Марија", "Јелена", "Наташа", "Ана", "Андреа", "Катарина", "Марина",
    "Мирјана", "Душица", "Лидија", "Весна", "Јованка", "Радмила", "Стана"
]

SERBIAN_LAST_NAMES_MALE = [
    "Јовановић", "Николић", "Петровић", "Марковић", "Стојковић", "Поповић",
    "Ивановић", "Миленковић", "Васиљевић", "Симоновић", "Павловић", "Миловановић",
    "Радовић", "Стаменковић", "Ћирић", "Димитријевић", "Андрејић", "Бојковић"
]
...
DRINKS = [
    ("Эспрессо", 80), ("Американо", 120), ("Латте", 180), ("Капучино", 170),
    ("Раф", 190), ("Мокачино", 200), ("Латте с корицей", 190), ("Какао", 150),
    ("Чай чёрный", 100), ("Чай зелёный", 100), ("Чай с мятой", 110),
    ("Морс ягодный", 130), ("Морс клюквенный", 140), ("Смузи банановый", 180),
    ("Смузи ягодный", 190), ("Компот", 80)
]

FOODS = [
    ("Круассан с шоколадом", 150), ("Круассан с маслом", 120),
    ("Маффин шоколадный", 130), ("Маффин ванильный", 120),
    ("Синabon классический", 180), ("Синabon с шоколадом", 200),
    ("Торт Наполеон", 250), ("Торт Медовик", 230),
    ("Пирожное Картошка", 100), ("Пирожное Эклер", 110),
    ("Пирожное Макарун", 130), ("Сэндвич с ветчиной", 220),
    ("Сэндвич с курицей", 230), ("Сэндвич вегетарианский", 200),
    ("Булочка с изюмом", 80), ("Пирог с яблоками", 140)
]

GOODS = [
    ("Стаканчики 350мл", 450), ("Стаканчики 500мл", 500),
    ("Крышки белые", 200), ("Крышки чёрные", 220),
    ("Сахар порционный", 150), ("Сироп ванильный", 380),
    ("Сироп карамельный", 380), ("Сироп ореховый", 400),
    ("Зёрна арабика 1кг", 1200), ("Зёрна смесь 1кг", 1000),
    ("Трубочки", 150), ("Салфетки", 100), ("Мешалки", 120)
]
...
def generate_phone(country: str = "RU") -> str:
    ...
    if country == "RU":
        ...
        area = random.choice(["495", "499", "812", "921", "916", "917", "985", "903", "906", "999"])
...
def generate_email(full_name: str, domain: str = None) -> str:
    ...
    name_part = full_name.lower().replace(" ", ".").replace("ј", "j").replace("ћ", "c").replace("ђ", "dj")
    name_part = name_part.replace("ć", "c").replace("č", "c").replace("š", "s").replace("ž", "z")
    ...
    for customer in customers:
        ...
        conn.execute("""
            UPDATE customers SET
                ...
                cohort_month = ?
            WHERE id = ?
        """, (total_revenue, avg_check, purchase_count, last_purchase, cohort_month, customer_id))
...
def seed_products(conn: sqlite3.Connection) -> list:
    ...
    for name, price in DRINKS:
        ...
        conn.execute("""
            ...
            VALUES (?, ?, 'drink', ?, 1)
        """, (sku, name, price))
        products.append({"id": conn.execute("SELECT last_insert_rowid()").fetchone()[0], "name": name, "price": price})
...
def seed_customers(conn: sqlite3.Connection, num_customers: int = 75) -> list:
    ...
    for i in range(num_customers):
        ...
        """, (
            phone, full_name, generate_qr_token(), birthday,
            marketing_allowed, data_processing_allowed,
...
def seed_transactions(conn: sqlite3.Connection, customers: list, products: list, num_transactions: int = 750) -> None:
    ...
    for i in range(num_transactions):
        ...
        bonus_used = 0 if random.random() > 0.3 else random.randint(10, min(100, total_amount // 2))
...
def seed_admin_users(conn: sqlite3.Connection) -> None:
    ...
    password_hash2 = hashlib.pbkdf2_hmac('sha256', "manager123".encode(), salt2.encode(), 200000).hex()
...
def main():
    ...
    parser.add_argument("--customers", type=int, default=75, help="Number of customers to create (default: 75)")
    parser.add_argument("--transactions", type=int, default=750, help="Number of transactions to create (default: 750)")
    ...
    try:
        ...
        stats = {
            "products": conn.execute("SELECT COUNT(*) as cnt FROM products").fetchone()["cnt"],
            "customers": conn.execute("SELECT COUNT(*) as cnt FROM customers").fetchone()["cnt"],
            "transactions": conn.execute("SELECT COUNT(*) as cnt FROM transactions").fetchone()["cnt"],
            "admin_users": conn.execute("SELECT COUNT(*) as cnt FROM admin_users").fetchone()["cnt"],
        }

...
from middleware.app.services.location_service import LocationService, get_location_service
...
class TestLocationService:
    ...
    def test_get_countries_returns_list(self, mock_db, mock_redis):
        ...
        with patch('middleware.app.services.location_service.get_redis', return_value=mock_redis):

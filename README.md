...
[![aiogram](https://img.shields.io/badge/aiogram-3.25.0-blue.svg)](https://docs.aiogram.dev/)
...
|-----------|------------|---------|---------|
| **Backend** | Python 3.14, FastAPI 0.135.1, aiogram 3.25.0 | Latest | Async Telegram bot and API |
| **Frontend** | React 19.2.4, TypeScript, Vite 7.3.1 | Latest | Admin UI |
| **Worker** | Celery 5.6.2, Redis 8.0 | Latest | Background task processing |
| **Integration** | frappe-client 0.1.0.dev0, httpx 0.28.1 | Latest | ERPNext integration with mock mode |
| **Database** | SQLite / PostgreSQL 2.0+ | Latest | Data storage |
| **Cache** | Redis 8.0-alpine | Latest | Session management, caching |
| **Testing** | pytest 8.3.4, Playwright 1.58.2 | Latest | Unit, integration, E2E tests |
| **Container** | Docker (Multi-stage) | Latest | Deployment and Isolation |
